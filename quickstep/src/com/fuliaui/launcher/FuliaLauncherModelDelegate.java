...
public class FuliaLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "FuliaLauncherModelDelegate";
    ...
    public FuliaLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
