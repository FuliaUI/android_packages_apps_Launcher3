...
import com.fuliaui.launcher.FuliaLauncher;
import com.fuliaui.launcher.FuliaLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        FuliaLauncher launcher = (FuliaLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        FuliaLauncherModelDelegate delegate = (FuliaLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        FuliaLauncher launcher = (FuliaLauncher) ActivityContext.lookupContext(getContext());
